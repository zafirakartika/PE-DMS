...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO projects (name, description, folder_id, created_by) VALUES (?, ?, ?, ?)");
    $stmt->execute([$name, $description, $folder_id, $_SESSION['user_id']]);

    redirect('projects.php?success=created');
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        <div style="margin-bottom: 1.5rem;">
            ...
            <h1 style="margin: 0; font-size: 1.4rem; color: #111827; font-weight: 800; letter-spacing: -0.5px;">Create Project</h1>
        </div>
        ...
        <div class="form-container">
            <form action="" method="POST" class="project-form">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" placeholder="Enter project name" required autofocus>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="4" placeholder="Enter project description (optional)"></textarea>
                </div>
